...
import com.zane.wms.domain.ItemTypeTreeSelect;
import com.github.pagehelper.PageHelper;
import com.zane.wms.pojo.query.ItemTypeQuery;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.data.domain.Pageable;
import org.apache.commons.lang3.StringUtils;
import org.springframework.stereotype.Service;
import com.zane.wms.mapper.ItemTypeMapper;
...
public class ItemTypeService {
    ...
    private List<ItemType> getChildList(List<ItemType> list, ItemType t) {
        ...
        for (ItemType n : list) {
            if (com.zane.common.utils.StringUtils.isNotNull(n.getParentId()) && n.getParentId().longValue() == t.getItemTypeId().longValue()) {
                tlist.add(n);
            }
        }
        return tlist;
